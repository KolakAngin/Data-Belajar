...
import com.dcfanbase.storyapp.data.paging.LoadingStateAdapter
...
import com.dcfanbase.storyapp.view.map.MapsActivity
...
class MainActivityGo : AppCompatActivity() {
    ...
    private fun setRecyleView() {
        binding.rViewHolder.layoutManager = LinearLayoutManager(this)
        val adapter = MainMenuRecyleView()
        binding.rViewHolder.adapter = adapter.withLoadStateFooter(
